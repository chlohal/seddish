...
///Automatically transformed from Busybox sed test sed backref from empty s uses range regex
#[test]
fn busybox_test_39() {
let expected = " eep woot eep ";
let input = " woot ";
let source = "/woot/s//eep \0 eep/";
test_from_busybox_sed(expected, input, source);
}

///Automatically transformed from Busybox sed test sed backref from empty s uses range regex with newline
#[test]
fn busybox_test_40() {
let expected = " eep woot eep\n ";
let input = " woot\n ";
...
///Automatically transformed from Busybox sed test sed uses previous regexp
#[test]
fn busybox_test_65() {
let expected = " q\nw\nw\n ";
let input = " q\nw\ne\nr\n ";
